...
/* mods
	...
	30Apri18 zig - add above footer widget area for footer menu.
 */
	...
	if (is_active_sidebar('reach-above-footer')) {
		echo '<footer id="reach-above-footer">';
			echo '<div id="reach-above-footer-wrap" class="be-wrap be-row clearfix">';
			dynamic_sidebar( 'reach-above-footer');
			echo '</div>';
		echo '</footer>';
	}
