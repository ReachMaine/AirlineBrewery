    ...
    if(isset($be_themes_data['opt-noshow-topbar']) && $be_themes_data['opt-noshow-topbar'] == 1){
        if(count($be_themes_data['opt-topbar-widgets-pos']['left']) > 1 || count($be_themes_data['opt-topbar-widgets-pos']['right']) > 1 ) {?>
            <div id="header-top-bar">
                <div id="header-top-bar-wrap" class="<?php if(true == $be_themes_data['opt-header-wrap']){?> be-wrap<?php } ?> clearfix zzz">
                    <?php
                    ...
                    ?>
                    <?php if ( is_active_sidebar( 'topbar-center') ) { /* zig Nov 23 */ ?>
                        <div id="header-top-bar-center">
                             <?php dynamic_sidebar( 'topbar-center' ); ?>
                        </div>
                    <?php }  ?>
                    <?php
